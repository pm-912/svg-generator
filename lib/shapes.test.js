...
// matches a circle
describe('Circle', () => {
    it('should have the properties of a circle with matching properties', () => {
...
describe('Triangle', () => {
    it('should have the properties of a triangle with matching properties', () => {
        const realTriangle = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="30, 30 280, 30 150, 200" fill="red"/><text x="150" y="100" font-size="60" text-anchor="middle" fill="black">AAA</text></svg>`;
...
describe('Square', () => {
    it('should have the properties of a square with matching properties', () => {
